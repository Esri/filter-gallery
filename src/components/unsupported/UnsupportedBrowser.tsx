        ...
        <div class={CSS.messageContainer}>
          ...
          <div class={CSS.browserIconContainer}>
            <img
              ...
              src="app/components/unsupported/assets/images/chrome.jpg"
              alt="Google Chrome Icon"
            />
            <img
              class={CSS.browserIcon}
              src="app/components/unsupported/assets/images/firefox.jpg"
              alt="Mozilla Firefox Icon"
            />
            <img class={CSS.browserIcon} src="app/components/unsupported/assets/images/safari.jpg" alt="Safari Icon" />
            {!this.isIE ? (
              <img
                class={CSS.browserIcon}
                src="app/components/unsupported/assets/images/new_edge.jpg"
