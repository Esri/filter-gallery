...
import { addToFavorites, removeFromFavorites, viewMap, viewScene, viewInMap, viewInScene, hashChange, push, VIEW_IN_MAP, VIEW_IN_SCENE, VIEW_SCENE } from "../../../_actions";
...
const defaultActions: CustomAction[] = [
    {
        ...
        asynchronous: false,
        onAction: (item: Pojo, state, dispatch) => {
            // dispatch(viewMap(item));
            dispatch(push(ioQuery.objectToQuery({
                viewType: VIEW_IN_MAP,
                viewId: item.id
            })));
        },
    ...
    },
    {
        ...
        allowed: (item: Pojo) => item.type === "Web Mapping Application",
        asynchronous: false,
        onAction: (item: Pojo) => {
            console.log("User wants to view the app!");
        },
    ...
    },
    {
        ...
        asynchronous: false,
        onAction: (item: Pojo, state, dispatch) => {
            // dispatch(viewInScene(item));
            dispatch(push(ioQuery.objectToQuery({
                viewType: VIEW_IN_SCENE,
                viewId: item.id
            })));
        },
