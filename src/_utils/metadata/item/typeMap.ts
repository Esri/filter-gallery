...
export const itemTypeMap: ItemTypeMap = {
  ...
  featureLayers: `(type:("Feature Collection" OR "Feature Service" OR "Stream Service" OR "WFS" OR "OGCFeatureServer") -typekeywords:"Table")`,
  ...
  instantApps: `(type:("Web Mapping Application") typekeywords:("configurableApp"))`,
