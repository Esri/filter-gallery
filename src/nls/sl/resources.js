define({
  ...
  "badges": {
    ...
    "subscriber": "Naročnik",
    "tooltips": {
      "altAuthoritative": "Verodostojni podatki: priporoča",
      "authoritative": "Verodostojni podatki: priporoča vaša organizacija",
      "deprecated": "Opuščeno: ni priporočljivo za uporabo",
      "livingAtlas": "Living Atlas: skrbno izbrana vsebina Esri",
      "marketplace": "Naveden v trgovini ArcGIS Marketplace",
  ...
  "dropdowns": {
    ...
    "sorting": {
      ...
      "ascending": {
        ...
        "modified": "Najmanj nedavno",
        "numviews": "Najmanj do najbolj",
      ...
      "descending": {
        ...
        "created": "Najnovejše",
        "modified": "Najnovejše",
        "numviews": "Najbolj do najmanj",
        "avgrating": "Od najvišje do najnižje ocene"
      }
    }
  },
  "filters": {
    "itemType": {
      "itemType": "Tip elementa",
      "filters": {
        "maps": "Karte",
        "webMaps": "Spletne karte",
        ...
        "geoprocessingTasks": "Opravila geoprocesiranja",
        "networkAnalysis": "Mrežna analiza",
        "files": "Datoteke",
        "documents": "Dokumenti",
        "images": "Slike",
        "pdfs": "PDF-ji",
        "webTools": "Spletna orodja",
        "notebooks": "Beležke"
      }
    },
    "date": {
  ...
  "gallery": {
    ...
    "resultCount": "Š_Items_____________č:",
    "searchPlaceholders": {
    ...
    "results": {
      "loadingItems": "Nalaganje elementov...",
      "requestError": "Prišlo je do napake v zahtevku.",
