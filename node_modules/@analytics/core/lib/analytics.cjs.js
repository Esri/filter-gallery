...
var ANON_ID = typeUtils.PREFIX + 'anon_id'; // __anon_id
...
var USER_ID = typeUtils.PREFIX + 'user_id'; // __user_id
...
var USER_TRAITS = typeUtils.PREFIX + 'user_traits'; // __user_traits
...
var tempKey = function tempKey(key) {
  return typeUtils.PREFIX + 'TEMP' + typeUtils.PREFIX + key;
};
...
function Debug() {
  ...
  globalStorageUtils.set(LIB_NAME, []); // Return debugger
  ...
  return function (createStore) {
    return function (reducer, preloadedState, enhancer) {
      ...
      var dispatch = function dispatch(action) {
        ...
        globalStorageUtils.globalContext[globalStorageUtils.KEY][LIB_NAME].push(a);
...
function analytics() {
  ...
  if (typeUtils.isBrowser && config.debug) {
    ...
    composeWithGlobalDebug = function composeWithGlobalDebug() {
      ...
      if (typeUtils.isObject(_typeof(arguments[0]))) return composeWithDebug();
