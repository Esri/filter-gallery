...
.time-picker.scale-s .button, .time-picker.scale-s .input {
...
.time-picker.scale-m .button, .time-picker.scale-m .input {
  padding-left: 1rem;
  padding-right: 1rem;
  padding-top: 0.5rem;
...
.time-picker.scale-l .button, .time-picker.scale-l .input {
