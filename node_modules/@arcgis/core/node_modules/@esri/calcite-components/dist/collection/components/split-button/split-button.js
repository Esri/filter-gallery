...
export class SplitButton {
  ...
  render() {
    ...
    return (h("div", { class: widthClasses },
      ...
      h("calcite-dropdown", { active: this.active, onClick: this.calciteSplitButtonSecondaryClickHandler, overlayPositioning: this.overlayPositioning, placement: "bottom-trailing", scale: this.scale, width: this.scale },
