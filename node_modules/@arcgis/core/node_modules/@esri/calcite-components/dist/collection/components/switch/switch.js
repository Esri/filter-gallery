...
export class Switch {
  ...
  render() {
    return (h(Host, { onKeyDown: this.keyDownHandler },
      h("div", { "aria-checked": this.checked.toString(), "aria-label": getLabelText(this), class: "container", onClick: this.clickHandler, ref: this.setSwitchEl, role: "switch", tabindex: this.tabindex },
        h("div", { class: "track" },
          h("div", { class: "handle" })),
