 ...
 */import{g as guid}from"./guid-196bd5ea.js";var autoTheme="calcite-theme-auto";var darkTheme="calcite-theme-dark";var lightTheme="calcite-theme-light";var CSS_UTILITY={autoTheme:autoTheme,darkTheme:darkTheme,lightTheme:lightTheme,rtl:"calcite--rtl"};var TEXT={loading:"Loading"};function ensureId(e){if(!e){return""}return e.id=e.id||e.tagName.toLowerCase()+"-"+guid()}function nodeListToArray(e){return Array.isArray(e)?e:Array.from(e)}function getThemeName(e){var t=closestElementCrossShadowBoundary(e,"."+CSS_UTILITY.darkTheme+", ."+CSS_UTILITY.lightTheme);return(t===null||t===void 0?void 0:t.classList.contains("calcite-theme-dark"))?"dark":"light"}function getElementDir(e){var t="dir";var r="["+t+"]";var n=closestElementCrossShadowBoundary(e,r);return n?n.getAttribute(t):"ltr"}function getElementProp(e,t,r){var n="["+t+"]";var o=e.closest(n);return o?o.getAttribute(t):r}function getRootNode(e){return e.getRootNode()}function getHost(e){return e.host||null}function queryElementsRoots(e,t){function r(e,n){if(!e){return n}if(e.assignedSlot){e=e.assignedSlot}var o=getRootNode(e);var l=Array.from(o.querySelectorAll(t));var i=l.filter((function(e){return!n.includes(e)}));n=__spreadArray(__spreadArray([],n),i);var a=getHost(o);return a?r(a,n):n}return r(e,[])}function queryElementRoots(e,t){var r=t.selector,n=t.id;function o(e){if(!e){return null}if(e.assignedSlot){e=e.assignedSlot}var t=getRootNode(e);var l=n?t.getElementById(n):r?t.querySelector(r):null;var i=getHost(t);return l?l:i?o(i):null}return o(e)}function closestElementCrossShadowBoundary(e,t){function r(e){return e?e.closest(t)||r(getHost(getRootNode(e))):null}return r(e)}function isCalciteFocusable(e){return typeof(e===null||e===void 0?void 0:e.setFocus)==="function"}function focusElement(e){return __awaiter(this,void 0,void 0,(function(){return __generator(this,(function(t){if(!e){return[2]}return[2,isCalciteFocusable(e)?e.setFocus():e.focus()]}))}))}var defaultSlotSelector=":not([slot])";function getSlotted(e,t,r){if(t&&!Array.isArray(t)&&typeof t!=="string"){r=t;t=null}var n=t?Array.isArray(t)?t.map((function(e){return'[slot="'+e+'"]'})).join(","):'[slot="'+t+'"]':defaultSlotSelector;if(r===null||r===void 0?void 0:r.all){return queryMultiple(e,n,r)}return querySingle(e,n,r)}function getDirectChildren(e,t){return e?Array.from(e.children||[]).filter((function(e){return e===null||e===void 0?void 0:e.matches(t)})):[]}function queryMultiple(e,t,r){var n=t===defaultSlotSelector?getDirectChildren(e,defaultSlotSelector):Array.from(e.querySelectorAll(t));n=r&&r.direct===false?n:n.filter((function(t){return t.parentElement===e}));n=(r===null||r===void 0?void 0:r.matches)?n.filter((function(e){return e===null||e===void 0?void 0:e.matches(r.matches)})):n;var o=r===null||r===void 0?void 0:r.selector;return o?n.map((function(e){return Array.from(e.querySelectorAll(o))})).reduce((function(e,t){return __spreadArray(__spreadArray([],e),t)}),[]).filter((function(e){return!!e})):n}function querySingle(e,t,r){var n=t===defaultSlotSelector?getDirectChildren(e,defaultSlotSelector)[0]||null:e.querySelector(t);n=r&&r.direct===false?n:(n===null||n===void 0?void 0:n.parentElement)===e?n:null;n=(r===null||r===void 0?void 0:r.matches)?(n===null||n===void 0?void 0:n.matches(r.matches))?n:null:n;var o=r===null||r===void 0?void 0:r.selector;return o?n===null||n===void 0?void 0:n.querySelector(o):n}function filterDirectChildren(e,t){return Array.from(e.children).filter((function(e){return e.matches(t)}))}function setRequestedIcon(e,t,r){if(typeof t==="string"&&t!==""){return t}else if(t===""){return e[r]}}function intersects(e,t){return!(t.left>e.right||t.right<e.left||t.top>e.bottom||t.bottom<e.top)}export{CSS_UTILITY as C,TEXT as T,getElementDir as a,getThemeName as b,closestElementCrossShadowBoundary as c,getElementProp as d,ensureId as e,focusElement as f,getSlotted as g,queryElementsRoots as h,isCalciteFocusable as i,intersects as j,filterDirectChildren as k,nodeListToArray as n,queryElementRoots as q,setRequestedIcon as s};