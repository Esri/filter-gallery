...
const ExpandToggle = require('./ExpandToggle-ef5d508c.js');
const dom = require('./dom-f3df220d.js');
const conditionalSlot = require('./conditionalSlot-92505fba.js');
require('./resources-ac80e82c.js');
require('./resources-7d5449fb.js');
...
let ActionPad = class {
  ...
  expandHandler(expandDisabled) {
    if (!expandDisabled) {
      ExpandToggle.toggleChildActionText({ parent: this.el, expanded: this.expanded });
    }
  }
