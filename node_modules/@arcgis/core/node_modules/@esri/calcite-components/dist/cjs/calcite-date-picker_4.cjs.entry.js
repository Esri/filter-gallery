...
const resources = require('./resources-8a9f4e9c.js');
const dom = require('./dom-f3df220d.js');
const Heading = require('./Heading-ef16f5df.js');
require('./locale-02462821.js');
require('./number-e813e801.js');
...
let DatePickerMonthHeader = class {
  ...
  setYear(localizedYear, increment = 0) {
    ...
    if (year && inRange && length === localizedYear.length) {
      ...
      const inRangeDate = resources.dateFromRange(nextDate, min, max);
      this.calciteDatePickerSelect.emit(inRangeDate);
      yearInput.value = resources.localizeNumber(inRangeDate.getFullYear(), localeData);
    }
    else {
      // leave the current active date and clean up garbage input
      yearInput.value = resources.localizeNumber(activeDate.getFullYear(), localeData);
    }
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
