...
let Switch = class {
  ...
  // --------------------------------------------------------------------------
  render() {
    return (index.h(index.Host, { onKeyDown: this.keyDownHandler }, index.h("div", { "aria-checked": this.checked.toString(), "aria-label": label.getLabelText(this), class: "container", onClick: this.clickHandler, ref: this.setSwitchEl, role: "switch", tabindex: this.tabindex }, index.h("div", { class: "track" }, index.h("div", { class: "handle" })), index.h(form.HiddenFormInputSlot, { component: this }))));
  }
