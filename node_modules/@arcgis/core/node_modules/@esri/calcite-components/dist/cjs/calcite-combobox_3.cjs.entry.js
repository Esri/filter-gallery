...
const forIn = require('./forIn-a5d553af.js');
const popper = require('./popper-13a2bb46.js');
...
let Combobox = class {
  ...
  renderPopperContainer() {
    ...
    return (index.h("div", { "aria-hidden": "true", class: { "popper-container": true, "popper-container--active": open }, ref: setMenuEl }, index.h("div", { class: classes, onTransitionEnd: this.transitionEnd, ref: setListContainerEl }, index.h("ul", { class: { list: true, "list--hide": hideList } }, index.h("slot", null)))));
  }
  renderIconStart() {
