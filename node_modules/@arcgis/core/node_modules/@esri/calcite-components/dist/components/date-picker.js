 ...
 */
import { getAssetPath, HTMLElement, createEvent, h, Host, Build, proxyCustomElement } from '@stencil/core/internal/client';
...
let DatePicker = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
DatePicker = /*@__PURE__*/ proxyCustomElement(DatePicker, [1, "calcite-date-picker", {
