...
let DatePickerMonthHeader = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
DatePickerMonthHeader = /*@__PURE__*/ proxyCustomElement(DatePickerMonthHeader, [1, "calcite-date-picker-month-header", {
    "selectedDate": [16],
    "activeDate": [16],
