...
*/
import{ScreenSpacePass as e}from"../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.js";import{glsl as o}from"../views/3d/webgl-engine/core/shaderModules/interfaces.js";import{ShaderBuilder as t}from"../views/3d/webgl-engine/core/shaderModules/ShaderBuilder.js";function g(){const g=new t;g.include(e,!1),g.fragment.uniforms.add("tileRows","float").add("tileSize","float");const r=2,l=8;return g.fragment.code.add(o`
    ...
    float getTextureForPointPerlinWorley(vec3 p) {
      float perlinNoise = getPerlinNoise(p, ${o.float(l)});

      float worley0 = worley(p, ${o.float(r)} * 2.0);
      float worley1 = worley(p, ${o.float(r)} * 8.0);
      float worley2 = worley(p, ${o.float(r)} * 14.0);
    ...
    float getTextureForPointWorley(vec3 p) {
      float worley0 = worley(p, ${o.float(r)});
      float worley1 = worley(p, ${o.float(r)} * 2.0);
      float worley2 = worley(p, ${o.float(r)} * 4.0);
      float worley3 = worley(p, ${o.float(r)} * 8.0);
  ...
  `),g.fragment.code.add(o`void main() {
float padWidth = 1.0;
...
}`),g}const r=Object.freeze({__proto__:null,build:g});export{r as N,g as b};
