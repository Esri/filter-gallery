...
CalciteShell$1 = /*@__PURE__*/ proxyCustomElement(CalciteShell$1, [1, "calcite-shell", {
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-shell":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteShell$1);
      }
      break;
  } });
}
...
const CalciteShell = CalciteShell$1;
