...
CalciteCombobox$1 = /*@__PURE__*/ proxyCustomElement(CalciteCombobox$1, [1, "calcite-combobox", {
    "active": [1540],
    "disabled": [516],
    "label": [1],
    "placeholder": [1],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-combobox":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteCombobox$1);
      }
      break;
    case "calcite-chip":
      if (!customElements.get(tagName)) {
...
const CalciteCombobox = CalciteCombobox$1;
