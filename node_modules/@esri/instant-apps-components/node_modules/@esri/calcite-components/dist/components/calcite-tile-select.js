...
import { d as defineCustomElement$3 } from './calcite-link2.js';
import { d as defineCustomElement$2 } from './calcite-tile2.js';
...
CalciteTileSelect$1 = /*@__PURE__*/ proxyCustomElement(CalciteTileSelect$1, [1, "calcite-tile-select", {
    "checked": [1540],
    "description": [513],
    "disabled": [516],
    "heading": [513],
    ...
    "focused": [32],
    "setFocus": [64]
  }, [[0, "calciteCheckboxChange", "checkboxChangeHandler"], [0, "calciteInternalCheckboxFocus", "checkboxFocusHandler"], [0, "calciteRadioButtonChange", "radioButtonChangeHandler"], [0, "calciteInternalRadioButtonCheckedChange", "radioButtonCheckedChangeHandler"], [0, "calciteInternalRadioButtonFocus", "radioButtonFocusHandler"], [0, "click", "click"], [1, "mouseenter", "mouseenter"], [1, "mouseleave", "mouseleave"]]]);
function defineCustomElement$1() {
  const components = ["calcite-tile-select", "calcite-icon", "calcite-link", "calcite-tile"];
  components.forEach(tagName => { switch (tagName) {
    case "calcite-tile-select":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteTileSelect$1);
      }
      break;
    case "calcite-icon":
      if (!customElements.get(tagName)) {
...
const CalciteTileSelect = CalciteTileSelect$1;
