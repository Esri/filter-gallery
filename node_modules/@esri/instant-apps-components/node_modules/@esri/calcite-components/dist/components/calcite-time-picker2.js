...
import { n as numberKeys, g as getKey, i as isActivationKey } from './key.js';
import { i as isValidNumber } from './number.js';
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-time-picker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteTimePicker);
      }
      break;
    case "calcite-icon":
      if (!customElements.get(tagName)) {
