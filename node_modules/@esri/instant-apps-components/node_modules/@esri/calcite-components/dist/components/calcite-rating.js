...
CalciteRating$1 = /*@__PURE__*/ proxyCustomElement(CalciteRating$1, [1, "calcite-rating", {
    "scale": [513],
    "value": [1538],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-rating":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteRating$1);
      }
      break;
    case "calcite-chip":
      if (!customElements.get(tagName)) {
...
const CalciteRating = CalciteRating$1;
