...
import { g as getLabelText, c as connectLabel, d as disconnectLabel } from './label.js';
...
CalciteInlineEditable$1 = /*@__PURE__*/ proxyCustomElement(CalciteInlineEditable$1, [6, "calcite-inline-editable", {
    "disabled": [516],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-inline-editable":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteInlineEditable$1);
      }
      break;
    case "calcite-button":
      if (!customElements.get(tagName)) {
...
const CalciteInlineEditable = CalciteInlineEditable$1;
