...
import { b as getSlotted, a as getElementDir, C as CSS_UTILITY } from './dom.js';
...
let CalciteChip = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CalciteChip = /*@__PURE__*/ proxyCustomElement(CalciteChip, [1, "calcite-chip", {
    "appearance": [513],
    "color": [513],
    "dismissible": [516],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-chip":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteChip);
      }
      break;
    case "calcite-icon":
      if (!customElements.get(tagName)) {
...
export { CalciteChip as C, defineCustomElement as d };
