...
import { d as defineCustomElement$1 } from './calcite-date-picker-day2.js';
...
let CalciteDatePickerMonth = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CalciteDatePickerMonth = /*@__PURE__*/ proxyCustomElement(CalciteDatePickerMonth, [1, "calcite-date-picker-month", {
    "selectedDate": [16],
    "activeDate": [16],
    "startDate": [16],
    "endDate": [16],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-date-picker-month":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteDatePickerMonth);
      }
      break;
...
export { CalciteDatePickerMonth as C, defineCustomElement as d };
