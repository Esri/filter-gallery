...
let CalciteDatePickerDay = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CalciteDatePickerDay = /*@__PURE__*/ proxyCustomElement(CalciteDatePickerDay, [1, "calcite-date-picker-day", {
    "day": [2],
    "disabled": [516],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-date-picker-day":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteDatePickerDay);
      }
      break;
  } });
}
...
export { CalciteDatePickerDay as C, defineCustomElement as d };
