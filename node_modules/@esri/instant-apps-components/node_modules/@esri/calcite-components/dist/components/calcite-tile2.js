...
let CalciteTile = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CalciteTile = /*@__PURE__*/ proxyCustomElement(CalciteTile, [1, "calcite-tile", {
    "active": [516],
    "description": [513],
    "disabled": [516],
    "embed": [516],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-tile":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteTile);
      }
      break;
    case "calcite-icon":
      if (!customElements.get(tagName)) {
...
export { CalciteTile as C, defineCustomElement as d };
