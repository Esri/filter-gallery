 ...
 */
import { Build, h, proxyCustomElement } from '@stencil/core/internal/client';
import { d as closestElementCrossShadowBoundary, a as getElementDir, C as CSS_UTILITY } from './dom.js';
...
let CalciteButton = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CalciteButton = /*@__PURE__*/ proxyCustomElement(CalciteButton, [1, "calcite-button", {
    "alignment": [513],
    "appearance": [513],
    "label": [1],
    "color": [513],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteButton);
      }
      break;
    case "calcite-icon":
      if (!customElements.get(tagName)) {
...
export { CalciteButton as C, defineCustomElement as d };
