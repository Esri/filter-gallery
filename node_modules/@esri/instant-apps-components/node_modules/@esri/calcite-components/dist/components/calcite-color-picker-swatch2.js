...
let CalciteColorPickerSwatch = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CalciteColorPickerSwatch = /*@__PURE__*/ proxyCustomElement(CalciteColorPickerSwatch, [1, "calcite-color-picker-swatch", {
    "active": [516],
    "color": [1],
    "scale": [513]
  }]);
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-color-picker-swatch":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteColorPickerSwatch);
      }
      break;
  } });
}
...
export { CalciteColorPickerSwatch as C, color as c, defineCustomElement as d };
