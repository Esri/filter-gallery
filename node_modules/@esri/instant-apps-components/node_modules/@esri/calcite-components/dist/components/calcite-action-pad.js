...
import { d as defineCustomElement$5 } from './calcite-icon2.js';
import { d as defineCustomElement$4 } from './calcite-loader2.js';
import { d as defineCustomElement$3 } from './calcite-popover2.js';
import { d as defineCustomElement$2 } from './calcite-tooltip-manager2.js';
...
CalciteActionPad$1 = /*@__PURE__*/ proxyCustomElement(CalciteActionPad$1, [1, "calcite-action-pad", {
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-action-pad":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteActionPad$1);
      }
      break;
    case "calcite-action":
      if (!customElements.get(tagName)) {
...
const CalciteActionPad = CalciteActionPad$1;
