...
CalciteAlert$1 = /*@__PURE__*/ proxyCustomElement(CalciteAlert$1, [1, "calcite-alert", {
    "active": [1540],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-alert":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteAlert$1);
      }
      break;
    case "calcite-chip":
      if (!customElements.get(tagName)) {
...
const CalciteAlert = CalciteAlert$1;
