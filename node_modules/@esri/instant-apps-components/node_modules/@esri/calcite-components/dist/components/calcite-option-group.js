...
CalciteOptionGroup$1 = /*@__PURE__*/ proxyCustomElement(CalciteOptionGroup$1, [1, "calcite-option-group", {
    "disabled": [516],
    "label": [1]
  }]);
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-option-group":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteOptionGroup$1);
      }
      break;
  } });
}
...
const CalciteOptionGroup = CalciteOptionGroup$1;
