 ...
 */
import { createEvent, h, Host, Build, proxyCustomElement } from '@stencil/core/internal/client';
import { T as TEXT, g as getLocaleData, d as defineCustomElement$8 } from './calcite-date-picker2.js';
...
import { d as defineCustomElement$7 } from './calcite-date-picker-day2.js';
import { d as defineCustomElement$6 } from './calcite-date-picker-month2.js';
import { d as defineCustomElement$5 } from './calcite-date-picker-month-header2.js';
import { d as defineCustomElement$4 } from './calcite-icon2.js';
import { d as defineCustomElement$3 } from './calcite-input2.js';
import { d as defineCustomElement$2 } from './calcite-progress2.js';
...
CalciteInputDatePicker$1 = /*@__PURE__*/ proxyCustomElement(CalciteInputDatePicker$1, [1, "calcite-input-date-picker", {
    "value": [1025],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-input-date-picker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteInputDatePicker$1);
      }
      break;
...
const CalciteInputDatePicker = CalciteInputDatePicker$1;
