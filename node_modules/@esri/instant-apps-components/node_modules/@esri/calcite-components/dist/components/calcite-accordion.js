...
CalciteAccordion$1 = /*@__PURE__*/ proxyCustomElement(CalciteAccordion$1, [1, "calcite-accordion", {
    "appearance": [513],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-accordion":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteAccordion$1);
      }
      break;
  } });
}
...
const CalciteAccordion = CalciteAccordion$1;
