...
let CalciteTabNav = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CalciteTabNav = /*@__PURE__*/ proxyCustomElement(CalciteTabNav, [1, "calcite-tab-nav", {
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-tab-nav":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalciteTabNav);
      }
      break;
  } });
}
...
export { CalciteTabNav as C, defineCustomElement as d };
