...
CalcitePagination$1 = /*@__PURE__*/ proxyCustomElement(CalcitePagination$1, [1, "calcite-pagination", {
    "num": [2],
    "start": [1026],
    "total": [2],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "calcite-pagination":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalcitePagination$1);
      }
      break;
    case "calcite-icon":
      if (!customElements.get(tagName)) {
...
const CalcitePagination = CalcitePagination$1;
