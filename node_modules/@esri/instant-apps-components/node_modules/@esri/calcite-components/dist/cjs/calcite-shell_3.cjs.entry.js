  ...
  renderContent() {
    const content = !!this.contentBehind
      ? [
        ...
        index.h("slot", { name: SLOTS$2.centerRow })
      ]
      : [
        index.h("div", { class: CSS$2.content }, index.h("slot", null), index.h("slot", { name: SLOTS$2.centerRow }))
      ];
    return content;
  }
  renderFooter() {
...
let CalciteShellCenterRow = class {
  ...
  render() {
    ...
    const contentNode = (index.h("div", { class: { [CSS$1.content]: true, [dom.CSS_UTILITY.rtl]: rtl } }, index.h("slot", null)));
    const actionBar = dom.getSlotted(el, SLOTS$1.actionBar);
    const actionBarNode = actionBar ? (index.h("div", { class: { [CSS$1.actionBarContainer]: true, [dom.CSS_UTILITY.rtl]: rtl } }, index.h("slot", { name: SLOTS$1.actionBar }))) : null;
...
let CalciteShellPanel = class {
  ...
  render() {
    ...
    return index.h(index.Fragment, null, mainNodes);
  }
  get el() { return index.getElement(this); }
