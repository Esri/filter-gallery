...
let CalciteButton = class {
  ...
  render() {
    ...
    const loader = (index.h("div", { class: CSS.buttonLoader }, this.hasLoader ? (index.h("calcite-loader", { active: true, class: this.loading ? CSS.loadingIn : CSS.loadingOut, inline: true, label: this.intlLoading, scale: "m" })) : null));
