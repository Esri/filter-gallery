...
let CalciteListItem = class {
  ...
  renderContentContainer() {
    ...
    return !nonInteractive ? (index.h("button", { class: { [CSS$1.contentContainer]: true, [CSS$1.contentContainerButton]: true }, disabled: disabled, ref: (focusEl) => (this.focusEl = focusEl) }, content)) : (index.h("div", { class: CSS$1.contentContainer, ref: () => (this.focusEl = null) }, content));
  }
  render() {
