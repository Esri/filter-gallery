...
let CalciteCheckbox = class {
  ...
  componentDidLoad() {
    this.input.setAttribute("aria-label", label.getLabelText(this));
  }
  ...
  render() {
    return (index.h(index.Host, { onClick: this.clickHandler }, index.h("div", { class: { focused: this.focused } }, index.h("svg", { class: "check-svg", viewBox: "0 0 16 16" }, index.h("path", { d: this.getPath() })), index.h("slot", null))));
  }
