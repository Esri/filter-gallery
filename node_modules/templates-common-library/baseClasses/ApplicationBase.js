...
define(["require", "exports", "./support/configParser", "esri/core/promiseUtils", "esri/identity/IdentityManager", "esri/identity/OAuthInfo", "esri/portal/Portal", "esri/portal/PortalItem", "esri/portal/PortalQueryParams", "esri/config", "esri/intl"], function (require, exports, configParser_1, promiseUtils_1, IdentityManager_1, OAuthInfo_1, Portal_1, PortalItem_1, PortalQueryParams_1, config_1, intl_1) {
    ...
    var ApplicationBase = /** @class */ (function () {
        ...
        function ApplicationBase(options) {
            ...
            //  locale
            //----------------------------------
            this.locale = (0, intl_1.getLocale)();
            //----------------------------------
            //  units
            //----------------------------------
            this.units = null;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            loadApplicationItem = appid ? this._loadItem(appid) : (0, promiseUtils_1.resolve)();
                            ...
                            fetchApplicationData = appid
                                ...
                                : (0, promiseUtils_1.resolve)();
                            loadPortal = portalSettings.fetch ? new Portal_1.default().load() : (0, promiseUtils_1.resolve)();
                            return [2 /*return*/, (0, promiseUtils_1.eachAlways)([
                                    ...
                                    if (applicationItem &&
                                        ...
                                        if (appAccess &&
                                            ...
                                            return (0, promiseUtils_1.reject)(appAccess.name);
                                        }
                                    }
                                    else if (applicationItemResponse.error) {
                                        return (0, promiseUtils_1.reject)(applicationItemResponse.error);
                                    }
                                    ...
                                    var applicationConfig = (0, configParser_1.parseConfig)(applicationData
                                    ...
                                    _this.locale = ((_b = _this.config) === null || _b === void 0 ? void 0 : _b.locale) || (0, intl_1.getLocale)();
                                    (0, intl_1.setLocale)(_this.locale);
                                    ...
                                    if ((applicationConfig === null || applicationConfig === void 0 ? void 0 : applicationConfig.googleAnalytics) && !((_c = _this.portal) === null || _c === void 0 ? void 0 : _c.eueiEnabled)) {
                                    ...
                                    var _d = _this.config, webmap = _d.webmap, webscene = _d.webscene, group = _d.group, draft = _d.draft;
                                    var webMapPromises = [];
                                    ...
                                    var promises = {
                                        webMap: webMapPromises ? (0, promiseUtils_1.eachAlways)(webMapPromises) : (0, promiseUtils_1.resolve)(),
                                        webScene: webScenePromises ? (0, promiseUtils_1.eachAlways)(webScenePromises) : (0, promiseUtils_1.resolve)(),
                                    ...
                                    return (0, promiseUtils_1.eachAlways)(promises)
                                        ...
                                        if (!(appAccess === null || appAccess === void 0 ? void 0 : appAccess.credential) && _this.invalidContentOrigin) {
                                            return (0, promiseUtils_1.reject)({
        ...
        ApplicationBase.prototype._isPortalServer = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            testingUrl = "".concat(this._getEsriEnvironmentPortalUrl(), "/sharing/rest/info");
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
