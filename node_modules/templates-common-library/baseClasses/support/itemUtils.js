    ...
    function createView(properties) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                map = properties.map;
                if (!map) {
                    return [2 /*return*/, (0, promiseUtils_1.reject)("properties does not contain a \"map\"")];
                }
                isWebMap = map.declaredClass === "esri.WebMap";
                isWebScene = map.declaredClass === "esri.WebScene";
                if (!isWebMap && !isWebScene) {
                    return [2 /*return*/, (0, promiseUtils_1.reject)("map is not a \"WebMap\" or \"WebScene\"")];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!marker || !view) {
                            return [2 /*return*/, (0, promiseUtils_1.resolve)()];
                        }
