var _analytics = (function (exports) {
  ...
  var n$2,
      ...
      l$1 = "*",
      p = "__",
      h$1 = "undefined" != typeof process ? process : {};
      (null == (n$2 = h$1.env) ? void 0 : n$2.NODE_ENV) || "";
      var z = "undefined" != typeof window;
      null != h$1.versions && null != h$1.versions.node;
      "undefined" != typeof Deno && void 0 !== Deno.core;
      z && "nodejs" === window.name || "undefined" != typeof navigator && (navigator.userAgent.includes("Node.js") || navigator.userAgent.includes("jsdom"));

  function C$1(n, e) {
    return typeof e === n;
  }

  var _ = C$1.bind(null, "function"),
      L$1 = C$1.bind(null, "string"),
      $ = C$1.bind(null, "undefined"),
      x$1 = C$1.bind(null, "boolean");
  ...
  function getUserPropFunc(storage) {
    return function getUserProp(key, instance, payload) {
      ...
      if (payload && M(payload) && payload[key]) {
        /*
  ...
  function shouldAbortAll(_ref5, pluginsCount) {
    ...
    if (!abort) return false;
    if (abort === true || L$1(abort)) return true;
  ...
  */
  ...
  var DynamicMiddleware = /*#__PURE__*/_createClass(function DynamicMiddleware() {
    ...
    _defineProperty(this, "addMiddleware", function (middlewares, position) {
      _this[position] = _this[position].concat(middlewares);
    });

    _defineProperty(this, "removeMiddleware", function (middleware, position) {
    ...
    _defineProperty(this, "dynamicMiddlewares", function (position) {
      return function (store) {
        return function (next) {
          return function (action) {
            var middlewareAPI = {
  ...
  */
  ...
  function analytics() {
        ...
        var _track = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(eventName, payload, options, callback) {
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  name = M(eventName) ? eventName.event : eventName;
                ...
                case 3:
                  data = M(eventName) ? eventName : payload || {};
                  opts = M(options) ? options : {};
    ...
    if (z && config.debug) {
      ...
      composeWithGlobalDebug = function composeWithGlobalDebug() {
        ...
        if (M(_typeof(arguments[0]))) return composeWithDebug();
  ...
  function x(t$1, e) {
    if (t$1) {
      var a$1 = A(e),
          s = O(t$1, l$1),
          n = {};
      return !$(s.localStorage) && d(a$1) && (localStorage.removeItem(t$1), n[r] = s.localStorage), !$(s.cookie) && h(a$1) && (u(t$1), n[t] = s.cookie), !$(s.sessionStorage) && N(a$1) && (sessionStorage.removeItem(t$1), n[a] = s.sessionStorage), !$(s.global) && F(a$1, l) && (i$2(t$1), n[l] = s.global), n;
    }
  }

  function A(t) {
    return t ? L$1(t) ? t : t.storage : f$1;
  }
  ...
  function analyticsLib() {
    ...
    return analytics(_objectSpread2$1(_objectSpread2$1({}, defaultSettings), opts));
  }
